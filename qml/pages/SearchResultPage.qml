...
Item {
    ...
    property var searchModel: typeof searchLibrary !== "undefined" ? searchLibrary : null
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        Text {
                            ...
                            text: (root.searchModel ? root.searchModel.count : 0) + "首歌曲"
                ...
                Text {
                    text: root.keyword.length > 0 ? ("搜索关键词: \"" + root.keyword + "\"") : "搜索本地音乐中的歌曲、歌手或专辑"
            ...
            Button {
                ...
                visible: root.searchModel && root.searchModel.count > 0
                ...
                onClicked: {
                    if (root.playerController && root.searchModel && root.searchModel.count > 0) {
                        root.playerController.playFromModel(root.searchModel, 0);
                    }
                }
            }
        }
        ...
        Item {
            ...
            ColumnLayout {
                ...
                Text {
                    Layout.alignment: Qt.AlignHCenter
                    text: root.keyword.length > 0 ? ("未找到与 \"" + root.keyword + "\" 相关的音乐") : "暂无匹配的搜索结果"
                    color: root.textSecondaryColor
                    font.pixelSize: 14
                }
            }
        ...
        ListView {
            ...
            delegate: Rectangle {
                ...
                readonly property bool isCurrent: root.playerController && root.playerController.currentLibrary === root.searchModel && root.playerController.currentIndex === index
                ...
                border.width: 1
                border.color: isCurrent ? "#1f385c" : "transparent"
                ...
                RowLayout {
                    ...
                    Button {
                        ...
                        onClicked: {
                            if (root.searchModel) {
                                root.searchModel.toggleFavorite(index);
                            }
                        }
                    }
                ...
                MouseArea {
                    ...
                    onClicked: {
                        if (root.playerController)
                            root.playerController.playFromModel(root.searchModel, index);
                    }
                }
            }
        }
