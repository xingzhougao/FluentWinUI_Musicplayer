...
Item {
    ...
    property var favoriteModel: typeof favoriteLibrary !== "undefined" ? favoriteLibrary : null
    ...
    ColumnLayout {
        ...
        RowLayout {
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        Text {
                            ...
                            text: (root.favoriteModel ? root.favoriteModel.count : 0) + "首歌曲"
            ...
            Button {
                ...
                onClicked: {
                    if(root.playerController && root.favoriteModel && root.favoriteModel.count > 0)
                    {
                        root.playerController.playFromModel(root.favoriteModel,0);
                    }
                }
            }
        }
        ...
        Item {
            ...
            delegate: Rectangle {
                ...
                readonly property bool isCurrent: root.playerController && root.playerController.currentLibrary === root.favoriteModel && root.playerController.currentIndex === index
                ...
                RowLayout {
                    ...
                    Button {
                        ...
                        onClicked: {
                            if(root.favoriteModel)
                            {
                                root.favoriteModel.toggleFavorite(index);
                            }
                        }
                    }
                ...
                MouseArea {
                    ...
                    onClicked: {
                        if (root.playerController)
                            root.playerController.playFromModel(root.favoriteModel, index);
                    }
                }
            }
        }
